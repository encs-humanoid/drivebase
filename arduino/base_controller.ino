...
int trigPin1 = 2 ; //(D2) Front Right ultrasonic sensor 1
int echoPin1 = 3 ; //(D3) Front Right ultrasonic sensor 1
int trigPin2 = 4 ; //(D4) Front Left ultrasonic sensor 2
int echoPin2 = 5 ; //(D5) Front Left ultrasonic sensor 2

int trigPin3 = 6 ; //(D6) Right Front Corner ultrasonic sensor 3
int echoPin3 = 7 ; //(D7) Right Front Corner ultrasonic sensor 3
int trigPin4 = 8 ; //(D8) Left Front Corner ultrasonic sensor 4
int echoPin4 = 9 ; //(D9) Left Front Corner ultrasonic sensor 4

#if 0
int trigPin5 = 10 ; //(D10) Right Front Corner ultrasonic sensor 5
int echoPin5 = 11 ; //(D11) Right Front Corner ultrasonic sensor 5
int trigPin6 = 12 ; //(D12) Left Front Corner ultrasonic sensor 6
int echoPin6 = 13 ; //(D13) Left Front Corner ultrasonic sensor 6
...
#else
int numSensors = 4; // Number of ultrasonic sensors mounted on the robot
int trigPins[] = { trigPin1, trigPin2, trigPin3, trigPin4 };
int echoPins[] = { echoPin1, echoPin2, echoPin3, echoPin4 };
#endif
...
#define MOTOR_MAX_SPEED  10  // 10-30
